...
public class ViewBackgroundAdapter extends RecyclerView.Adapter<ViewBackgroundAdapter.MyViewHolder>{
    private int layoutId;
    private ArrayList<ImageBackground> arrayList;
    private Activity activity;

    public ViewBackgroundAdapter(int layoutId, ArrayList<ImageBackground> arrayList, Activity activity) {
